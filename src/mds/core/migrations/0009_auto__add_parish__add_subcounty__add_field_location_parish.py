...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Parish'
        db.create_table(u'core_parish', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('subcounty', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Subcounty'])),
        ))
        db.send_create_signal('core', ['Parish'])

        # Adding model 'Subcounty'
        db.create_table(u'core_subcounty', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('core', ['Subcounty'])

        # Adding field 'Location.parish'
        db.add_column(u'core_location', 'parish',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Parish'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Parish'
        db.delete_table(u'core_parish')

        # Deleting model 'Subcounty'
        db.delete_table(u'core_subcounty')

        # Deleting field 'Location.parish'
        db.delete_column(u'core_location', 'parish_id')
    ...
    models = {
        ...
        'core.ambulancedriver': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'3bb318a0-6cce-4e58-848d-ed09b22307ee'", 'max_length': '36'})
        },
        'core.concept': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'34b68442-6c28-46d3-b101-c43cb5040bd9'", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.device': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'ee0286d9-bf11-4890-a957-14efdf39adf6'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.encounter': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'1f8b8c7e-8dfd-4b5c-814f-2aead32652a5'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.event': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'895f287c-d555-4b5b-8196-bf67b61abab3'", 'unique': 'True', 'max_length': '36'})
        },
        'core.instruction': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'459aa344-7c44-45c4-b7d6-fe7fba69905c'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.location': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'d26e5f78-7b7f-4578-b6e7-2a736fc37cf1'", 'unique': 'True', 'max_length': '36'})
        },
        'core.notification': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'9257248a-96f1-49b4-9cf9-d8c6fb844952'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.observation': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'abdfeaa1-15a6-41b2-a9d3-e95248e0b4ce'", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.observer': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'d4527650-4d85-47b7-bfb0-c60850bc9303'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.parish': {
        ...
        'core.procedure': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'bf8b2d31-c1aa-4566-ad8b-a4dbbcca4107'", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.relationship': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'0cce7994-dfba-4cb5-a436-a30dd627aeb6'", 'unique': 'True', 'max_length': '36'})
        },
        'core.relationshipcategory': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'bdff1016-c99c-45bd-b06f-478d5dfb01d6'", 'unique': 'True', 'max_length': '36'})
        },
        'core.subcounty': {
        ...
        'core.subject': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'4f11ecbd-2f09-4bbe-9a69-0124335a9a2f'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        }
    }
