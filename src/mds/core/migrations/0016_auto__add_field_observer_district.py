...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_observer', 'district',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'core_observer', 'district_id')
    ...
    models = {
        ...
        'core.ambulancedriver': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'1f873a6c-460b-42cb-8722-5be99c03c868'", 'max_length': '36'})
        },
        'core.concept': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'1b48f699-1bfd-48aa-aa64-9072085fc78d'", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.device': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'04c62519-12f8-453c-86db-b32dcc15a3da'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.district': {
        ...
        'core.encounter': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'a0e4dfa6-281d-4119-bdd2-0f7c45524dfb'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.event': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'4d24c719-bf66-4273-8ade-7c0f2f281091'", 'unique': 'True', 'max_length': '36'})
        },
        'core.instruction': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'91404246-e7b5-4f50-8527-a49bc0a59f76'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.location': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'027e36a6-33b8-4bf8-9f4b-a2f658d47a7e'", 'unique': 'True', 'max_length': '36'})
        },
        'core.notification': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'d1a227f8-fbeb-42f6-bd8e-253620c8f9ac'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.observation': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'3b0b29a3-25fd-46dd-8f50-14045e1a7a3b'", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.observer': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'29dbc720-1f0f-486a-8b64-ddd56cce5d27'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.parish': {
        ...
        'core.procedure': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'ce50fe92-1e45-4933-beab-ac5a2372a74d'", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.relationship': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'3e6b7ee8-441a-4b81-9157-e2fffc8562ef'", 'unique': 'True', 'max_length': '36'})
        },
        'core.relationshipcategory': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'da409ea1-bcca-4ba5-8cea-8b12f05b6e26'", 'unique': 'True', 'max_length': '36'})
        },
        'core.subcounty': {
        ...
        'core.subject': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'e25396d1-bb75-4919-9ee4-44115ee40352'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        }
    }
