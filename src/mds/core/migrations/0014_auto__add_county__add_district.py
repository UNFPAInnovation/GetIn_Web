...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'County'
        db.create_table(u'core_county', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('district', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.District'])),
        ))
    ...
    models = {
        ...
        'core.ambulancedriver': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'fc7c29eb-0075-41aa-a6cf-ecfa857c2363'", 'max_length': '36'})
        },
        'core.concept': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'95f59702-2203-48c3-ac71-2a6ccb1697de'", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.device': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'880dd596-22ee-448f-986e-2cb2ba550d13'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.district': {
        ...
        'core.encounter': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'431c52be-71be-4c29-85a3-287672287882'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.event': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'a70a24c0-3894-4971-84bb-d439fd193bff'", 'unique': 'True', 'max_length': '36'})
        },
        'core.instruction': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'171e25a1-22a8-46bc-a41b-de42108c9463'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.location': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'b1415279-e08b-4722-99ea-3ec1412e6cdd'", 'unique': 'True', 'max_length': '36'})
        },
        'core.notification': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'8458a138-de73-4bb0-a189-cfc99a557a56'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.observation': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'f0ed6b2d-0af3-4e66-9539-96953b7a35c6'", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.observer': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'c367fe1d-14dc-44fb-a4b1-2df26e5abe22'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.parish': {
        ...
        'core.procedure': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'bf0feaaf-5675-44f5-b0e6-50df9e9111c4'", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.relationship': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'51051d4d-b9ce-410f-9bc5-56d8020050b4'", 'unique': 'True', 'max_length': '36'})
        },
        'core.relationshipcategory': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'2975a313-2714-4daa-889f-41bc30c4e805'", 'unique': 'True', 'max_length': '36'})
        },
        'core.subcounty': {
        ...
        'core.subject': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'8ddb4106-3955-4e91-bfdf-6065b952cdee'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        }
    }
