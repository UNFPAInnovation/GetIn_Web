...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patients.system_id'
        db.add_column(u'core_patients', 'system_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patients.system_id'
        db.delete_column(u'core_patients', 'system_id')
    ...
    models = {
        ...
        'core.ambulancedriver': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'80e43217-67e5-4ed0-a995-66e5d84bb116'", 'max_length': '36'})
        },
        'core.concept': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'5d85f9c6-33a7-494c-98f1-3064df499aab'", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.device': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'bff051dc-dd40-48e2-a04b-6c8c12d42c0b'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.encounter': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'be550601-3486-4d7d-a150-7dee4997e889'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.event': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'e46db2c7-a101-4b00-8e4f-34bc4fef084b'", 'unique': 'True', 'max_length': '36'})
        },
        'core.instruction': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'1a407497-44a4-48ba-9fc7-d0eb7b9838f0'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.location': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'5a719af0-36aa-4b2c-8d1c-2f741fda9c81'", 'unique': 'True', 'max_length': '36'})
        },
        'core.notification': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'f9a621d8-0c97-4736-b0f9-32a868773897'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.observation': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'6a7f1409-48cc-4c11-8942-48058a615fb4'", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.observer': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'398cb078-c61e-457f-aa12-1ad0beabe4ca'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.parish': {
        ...
        'core.procedure': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'fbcc8ebf-3f41-47af-9bfd-4422c86440c5'", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.relationship': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'b0f6a0cc-9ca9-4d4e-93e9-e69750e67a14'", 'unique': 'True', 'max_length': '36'})
        },
        'core.relationshipcategory': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'be132b75-19e8-463d-9f03-3c2f063e1de2'", 'unique': 'True', 'max_length': '36'})
        },
        'core.subcounty': {
        ...
        'core.subject': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'d2220bf5-67d7-4d4b-885f-fb6a1992969d'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        }
    }
