...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AmbulanceDriver.subcounty'
        db.add_column(u'core_ambulancedriver', 'subcounty',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Subcounty'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AmbulanceDriver.subcounty'
        db.delete_column(u'core_ambulancedriver', 'subcounty_id')
    ...
    models = {
        ...
        'core.ambulancedriver': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'8bcc665c-d77d-4f05-9cb7-081b4b3461dd'", 'max_length': '36'})
        },
        'core.concept': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'c70271a8-f349-44de-87d2-6d45f8865e4f'", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.device': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'473778e2-6ec9-49df-8040-601059ab0cb0'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.encounter': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'5773eeca-fbcd-4dc9-a3d8-26e96c9e9e5b'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.event': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'1cb7e283-518f-45d3-b30d-2df54cd03408'", 'unique': 'True', 'max_length': '36'})
        },
        'core.instruction': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'6aa445bd-a9c6-4272-a59e-c3ae56179f2c'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.location': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'baba01e1-2b82-460d-a19f-020011d47644'", 'unique': 'True', 'max_length': '36'})
        },
        'core.notification': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'0f34bb50-bc3f-4cfc-81b8-14ffc4d83abe'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.observation': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'121ec011-3fb5-4fbb-8e3e-d68cdeeb0840'", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.observer': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'66847707-b9f5-49a4-929e-08bc21f38c75'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.parish': {
        ...
        'core.procedure': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'6260c5e4-381d-4440-b915-bafb66962d69'", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.relationship': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'d5eed9bd-475d-41db-91ff-219aa7917896'", 'unique': 'True', 'max_length': '36'})
        },
        'core.relationshipcategory': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'191bdc7f-2b74-4c7a-9023-1337d1f7b8f7'", 'unique': 'True', 'max_length': '36'})
        },
        'core.subcounty': {
        ...
        'core.subject': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'b9aa8ae3-6eb7-4804-9094-c887df82f627'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        }
    }
